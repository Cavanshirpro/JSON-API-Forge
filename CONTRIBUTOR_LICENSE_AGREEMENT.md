# JSON API Forge Contributor License Agreement (CLA)
...
## 1. Project Owner
**Project Owner** means **Cavanşir Qurbanzadə (@Cavanshirpro)** and any lawful successor or assignee acquiring the relevant JSON API Forge project rights. The canonical repository is `https://github.com/YoungLionOrganization/JSON-API-Forge` unless officially replaced.
