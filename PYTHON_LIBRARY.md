...
- Session, invitation and call credentials must match the server's exact v0.5.1 token formats.
...
2. Ruff, compilation and Python 3.10–3.14 unit matrices on Linux, Windows and macOS x64/ARM64.
