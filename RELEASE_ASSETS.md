...
Download the `JSON-API-Forge-python-library-v0.5.1` artifact from the successful `Python SDK build` Action. It contains:

- `json_api_forge_client-0.5.1-py3-none-any.whl`
- `json_api_forge_client-0.5.1.tar.gz`
- `JSON-API-Forge-python-library-v0.5.1-source.zip`
- `SHA256SUMS`
