...
Synthetic financial operations workflow with dual-control permissions, batch totals and idempotent audit transitions.
...
Docs: `http://127.0.0.1:8000/api/finance-ops/v1/_docs`
