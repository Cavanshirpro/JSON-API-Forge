...
Operational incident control with responder assignments, runbook policies, immutable events and realtime command updates.
...
Docs: `http://127.0.0.1:8000/api/incident-command/v1/_docs`
