...
Tenant subscription lifecycle, plan policies, usage amounts, idempotent transitions and operator dashboards.
...
Docs: `http://127.0.0.1:8000/api/subscription-platform/v1/_docs`
