...
Match lifecycle, official assignments, ruleset policies, result audit events and realtime tournament channels.
...
Docs: `http://127.0.0.1:8000/api/tournament-engine/v1/_docs`
