...
Inventory batch ownership, allocation workflow, audit events, quantity totals and bounded search/filter surfaces.
...
Docs: `http://127.0.0.1:8000/api/warehouse-grid/v1/_docs`
