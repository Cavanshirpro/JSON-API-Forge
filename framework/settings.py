...
class Settings(BaseSettings):
    ...
    apps_auto_reload: bool = True
    apps_reload_interval_seconds: float = Field(default=1.0, ge=0.1, le=60.0)
    apps_reload_debounce_seconds: float = Field(default=0.5, ge=0.1, le=60.0)
